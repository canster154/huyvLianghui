$(function () {
    TweenMax.from($('.bgBox~*'), 4, { scale: 5, opacity: 0, delay: 0 });
    TweenMax.from($('.bgBox'), 4, { scale: 1, opacity: 0, delay: 0 });
    TweenMax.to($('.bgBox'), 4, { scale: 1, opacity: 1, delay: 0 });
    ...
    TweenMax.from($('.theScarf'), 6, { scale: 5, y:"200%",x:"0", opacity:0,ease: Power2.easeOut,delay:5 });
    TweenMax.to($('.theScarf'), 6, { opacity:1, ease: Power2.easeOut,delay:5 });
    TweenMax.to($('.bgBox~*'), 3, { scale: 1, opacity: 1, delay: 8 });
})
